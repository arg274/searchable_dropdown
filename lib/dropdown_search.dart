...
class DropdownSearch<T> extends StatefulWidget {
  ...
  /// padding for multiselect item chip
  final EdgeInsetsGeometry? multiselectItemPadding;

  /// margin for multiselect item chip
  final EdgeInsetsGeometry? multiselectItemMargin;

  /// decoration for multiselect item chip
  final BoxDecoration? multiselectItemBoxDecoration;

  /// text style for multiselect item chip
  final TextStyle? multiselectItemTextStyle;
  ...
  DropdownSearch(
      ...
      @Deprecated('Use labelText prop from dropdownSearchDecoration')
          this.label,
      @Deprecated('Use hintText prop from dropdownSearchDecoration')
          this.hint,
      ...
      this.multiselectItemPadding,
      this.multiselectItemMargin,
      this.multiselectItemBoxDecoration,
      this.multiselectItemTextStyle})
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
  ...
  Widget _defaultSelectedItemWidget() {
    Widget defaultItemMultiSelectionMode(T item) {
      return Container(
        padding: widget.multiselectItemPadding ??
            EdgeInsets.symmetric(horizontal: 6, vertical: 3),
        margin:
            widget.multiselectItemMargin ?? EdgeInsets.symmetric(horizontal: 2),
        decoration: widget.multiselectItemBoxDecoration ??
            BoxDecoration(
        ...
        child: Text(
          ...
          style: widget.multiselectItemTextStyle ??
